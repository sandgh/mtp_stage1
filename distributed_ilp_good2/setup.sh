...
ulimit -c unlimited
./svm_latent_learn_online -n 10 -f tmp1/ -w 0.5 -y 0.9 -z dataset/train-riedel-10p.1.stats -o 0.0 -a 0 -b 1 -C 5 -c 5 -e 0.5 -M 10 -K 20 -E 40 dataset/reidel_trainSVM.data reidel-full-ilp.model > $new_out_file
