...
for curr_c = config.c_range
    ...
    for i=1:NO_OF_RELNS
        ...
        [model_final] = trainSVM_macro([1;gold_db_matrix_trn(:,i)], 1, [feature_vect_trn(nz_row,:); feature_vect_trn], config);
        
        %%%pridiction for the current relation
        
        [predicted_matrix_trn_temp, accuracy_trn, decision_values_trn_temp] = svmpredict([1;gold_db_matrix_trn(:,i)], [feature_vect_trn(nz_row,:);feature_vect_trn], model_final);
