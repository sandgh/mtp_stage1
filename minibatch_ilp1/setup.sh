...
ulimit -c unlimited
./svm_latent_learn_online -n 10 -f tmp1/ -w 0.5 -y 0.9 -z dataset/train-riedel-10p.1.stats -o 0.0 -a 0 -b 1 -C 5 -c 5 -e 0.5 -K 1 -E 1 dataset/train-riedel-10p.2.data riedel_10p_2.model> $new_out_file
